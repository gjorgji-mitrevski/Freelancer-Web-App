  ...
  <?php
      ...
      if (!$conn) {
        ...
        if(isset($_POST['submit'])){
          $select = "SELECT * FROM personal WHERE username='$profil'";
          ...
          while($row = $result->fetch_assoc()) {              
             ...
             $insert = "INSERT INTO `cv`(`username`, `title`, `email`, `description`) VALUES ('$profil','$tittle','$contact_email','$des')";
             $conn->query($insert);}
      }
            ...
            <div class="row">
                <div class="col-md-2 ">
                     <div class="list-group ">
                      ...
                      <a href="http://localhost:8080/work/post/cv.php" class="list-group-item list-group-item-action active">Post CV</a>
                ...
                <?php
                $select = "SELECT * FROM `cv` WHERE username='$profil'";
                $result = $conn->query($select);  
