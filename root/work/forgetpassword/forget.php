...
<html lang="en">
  ...
  <body data-spy="scroll" data-target="#navbar" data-offset="150">
        ...
        <div class="jumbotron" id="jumbotron">
          ...
          <a href="http://localhost:8080/work/forgetpassword/personal.php" class="btn btn-info" role="link">Personal</a>
          <a href="http://localhost:8080/work/forgetpassword/company.php" class="btn btn-info" role="link">Company</a>
