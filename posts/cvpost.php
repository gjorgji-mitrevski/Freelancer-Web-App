        ...
        <a class="navbar-brand" href="#jumbotron">  <img src="undraw_dev_productivity_umsq.png" height="40px" width="100px"> </a>
            ...
            <div class="row">
                <div class="col-md-2 ">
                     <div class="list-group ">
                      <a href="/dashboard/company.php" class="list-group-item list-group-item-action">Dashboard</a>
                      <a href="#" class="list-group-item list-group-item-action active">Search CVs</a>
          ...
          while($row = $result->fetch_assoc()) { 
              ...
              <div class="form-group row">                                        
                                  <div class="col-md-12">
                                  <a href="/read/cv.php?id=<?php echo $id?>"><h2><?php echo $tittle ?></h2 ></a>
                                  
                                  <p><?php echo substr($description , 0, 400);echo '';?></p><hr><hr>
                                  <div>
